...
public class testfunc {
	...
	public void test_func(double[] x, double[] f, int nx, int mx,int func_num)throws Exception{
		...
		if (ini_flag==0) /* initiailization*/
		{
			...
			File fpt = new File("src/Optimization/cec13/input_data/M_D"+nx+".txt");//* Load M data *
			...
			fpt=new File("src/Optimization/cec13/input_data/shift_data.txt");
